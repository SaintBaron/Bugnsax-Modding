...
<b>Below you can see some of the most commonly-used filetypes in Bugsnax. The restriction on what files can and can't be used it set by the Irrlicht Engine. You can find a full list of supported files <a href="https://irrlicht.sourceforge.io/?page_id=45">here</a>.
